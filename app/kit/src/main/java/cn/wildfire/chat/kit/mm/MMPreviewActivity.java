        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(entry.getMediaLocalPath())) {
                    ...
                    File videoFile = new File(Config.Companion.getVIDEO_SAVE_DIR(), name);
                    if (!videoFile.exists()) {
                        view.setTag(name);
                        ProgressBar loadingProgressBar = view.findViewById(R.id.loading);
                        loadingProgressBar.setVisibility(View.VISIBLE);
                        final WeakReference<View> viewWeakReference = new WeakReference<>(view);
                        DownloadManager.get().download(entry.getMediaUrl(), Config.Companion.getVIDEO_SAVE_DIR(), name, new DownloadManager.OnDownloadListener() {
                            @Override
