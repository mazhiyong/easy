...
abstract class VersionedGestureDetector {
    internal var mListener: OnGestureListener? = null
    ...
    companion object {
        internal val LOG_TAG = "VersionedGestureDetector"
        ...
        fun newInstance(context: Context, listener: OnGestureListener): VersionedGestureDetector {
            ...
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                detector = CupcakeDetector(context)
            } else if (sdkVersion < Build.VERSION_CODES.FROYO) {
                detector = EclairDetector(context)
            } else {
                detector = FroyoDetector(context)
            }
