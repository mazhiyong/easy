...
class CountDownProgressView : AppCompatTextView {
    //TODO 圆实心的颜色
    ...
    //TODO 进度条通知
    private lateinit var mProgressListener: OnProgressListener
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        mPaint!!.style = Paint.Style.FILL //实心填充style
        mPaint!!.color = circSolidColor
        canvas.drawCircle(mBounds!!.centerX().toFloat(), mBounds!!.centerY().toFloat(), circRadius.toFloat(), mPaint!!)


        //TODO 画外边框(空心圆,即园边框)
        mPaint!!.isAntiAlias = true//设置抗锯齿
        mPaint!!.style = Paint.Style.STROKE//空心style
        mPaint!!.strokeWidth = circFrameWidth.toFloat()//设置空心线宽度
        mPaint!!.color = circFrameColor
        ...
        canvas.drawArc(mArcRectF!!, -90f, (360 * progress / 100).toFloat(), false, mPaint!!) //这里的-90.是方向，大家可以改成0，90，180，-90等就可以看到效果区别
...
//        listener as OnProgressListener
