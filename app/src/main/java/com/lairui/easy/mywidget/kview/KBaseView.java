...
public abstract class KBaseView extends BaseView {
    ...
    protected float mLegendTxtSize = 22;
...
//        }
    ...
    public void setTimeSharingData(List<Quotes> quotesList) {
        if (quotesList == null || quotesList.isEmpty()) {
            ...
            Log.e("show", "setKViewData: 数据异常");
            return;
        }
        LogUtil.INSTANCE.i("show","quotesList:"+quotesList.size());
    ...
    public void pushingTimeSharingData(Quotes quotes, long period) {
        ...
        if (UtilTools.Companion.empty(mQuotesList)) return;
