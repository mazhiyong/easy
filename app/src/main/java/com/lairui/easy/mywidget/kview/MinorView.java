...
public class MinorView extends KBaseView {
    ...
    private void drawPressLegend(Canvas canvas) {
        ...
        switch (mMinorType) {
            case MACD:
                showTxt = "DIFF:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.dif, mDigits) + " ";
                mMacdPaint.setColor(mMacdDifColor);
                canvas.drawText(showTxt, x,
                        y, mMacdPaint);

                float leftWidth11 = mMacdPaint.measureText(showTxt);
                showTxt = "DEA:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.dea, mDigits) + " ";
                ...
                showTxt = "MACD:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.macd, mDigits) + " ";
                mMacdPaint.setColor(mMacdMacdColor);
                canvas.drawText(showTxt, (x + leftWidth11 + leftWidth12),
                        y, mMacdPaint);
                break;
            case RSI:
                showTxt = "RSI6:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.rsi6, mDigits) + " ";
                mRsiPaint.setColor(mRsi6Color);
                canvas.drawText(showTxt, (x),
                        y, mRsiPaint);

                float leftWidth21 = mRsiPaint.measureText(showTxt);
                showTxt = "RSI12:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.rsi12, mDigits) + " ";
                mRsiPaint.setColor(mRsi12Color);
                canvas.drawText(showTxt, (x + leftWidth21),
                        y, mRsiPaint);

                float leftWidth22 = mRsiPaint.measureText(showTxt);
                showTxt = "RSI24:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.rsi24, mDigits) + " ";
                mRsiPaint.setColor(mRsi24Color);
                canvas.drawText(showTxt, (x + leftWidth21 + leftWidth22),
                        y, mRsiPaint);
                break;
            case KDJ:
                showTxt = "K:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.k, mDigits) + " ";
                mKdjPaint.setColor(mKColor);
                canvas.drawText(showTxt, (x),
                        y, mKdjPaint);

                float leftWidth = mKdjPaint.measureText(showTxt);
                showTxt = "D:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.d, mDigits) + " ";
                mKdjPaint.setColor(mDColor);
                canvas.drawText(showTxt, (x + leftWidth),
                        y, mKdjPaint);

                float leftWidth2 = mKdjPaint.measureText(showTxt);
                showTxt = "J:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.j, mDigits) + " ";
    ...
    private void drawYRightTxt(Canvas canvas) {
        ...
        //draw min
        canvas.drawText(UtilTools.Companion.numFormat(mMinY, mDigits),
                x,
                minY, mXYTxtPaint);
        //draw max
        canvas.drawText(UtilTools.Companion.numFormat(mMaxY, mDigits),
                x,
                maxY, mXYTxtPaint);
        //draw middle
        canvas.drawText(UtilTools.Companion.numFormat((mMaxY + mMinY) / 2.0, mDigits),
                x, (minY + maxY) / 2.0f,
                mXYTxtPaint);
    }
