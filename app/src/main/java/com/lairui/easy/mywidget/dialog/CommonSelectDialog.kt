...
import com.lairui.easy.ui.temporary.adapter.CommonSelectAdapter
...
class CommonSelectDialog : BaseDialog {
    ...
    private var mAdapter: CommonSelectAdapter? = null
    ...
    override fun onCreateView(): View {
        val view = View.inflate(mContext, R.layout.dialong_select_common_layout, null)
    ...
    private fun init() {
        if (mAdapter == null) {
            mAdapter = CommonSelectAdapter(mContext!!, mDatas)
