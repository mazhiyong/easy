...
public class VolView extends KBaseView {
    ...
    private void drawPressLegend(Canvas canvas) {
        ...
        String showTxt = "VOL:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.vol, mDigits) + " ";
        mMacdPaint.setColor(mMacdDifColor);
        canvas.drawText(showTxt, x,
                y, mMacdPaint);

        float leftWidth11 = mMacdPaint.measureText(showTxt);
        showTxt = "MA5:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.volMa5, mDigits) + " ";
        ...
        showTxt = "MA10:" + UtilTools.Companion.numFormat(mCurrLongPressQuotes.volMa10, mDigits) + " ";
