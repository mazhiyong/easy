...
/**
 */
class HangYeAdapter(context: Context) : ListBaseAdapter(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ViewHolder(mLayoutInflater.inflate(R.layout.item_hangye, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        viewHolder.mArrowView!!.visibility = View.GONE

        viewHolder.mItemName!!.text = item["name"]!!.toString() + ""
