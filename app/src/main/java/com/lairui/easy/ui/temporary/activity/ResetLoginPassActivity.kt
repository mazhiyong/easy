 ...
 * 重置登录密码  界面
 */
class ResetLoginPassActivity : BasicActivity(), RequestView {
    ...
    lateinit var mPhoneEdit: EditText
    ...
    override val contentView: Int
        get() = R.layout.activity_reset_login_pass
    ...
    fun onViewClicked(view: View) {
        ...
        when (view.id) {
            ...
            R.id.but_next -> {
                mPhone = mPhoneEdit!!.text.toString() + ""
                if (UtilTools.isEmpty(mPhoneEdit!!, "手机号码")) {
    ...
    override fun loadDataSuccess(tData: MutableMap<String, Any>, mType: String) {
        ...
        when (mType) {
            MethodUrl.resetPassCode -> {
                ...
                intent = Intent(this@ResetLoginPassActivity, CodeMsgActivity::class.java)
