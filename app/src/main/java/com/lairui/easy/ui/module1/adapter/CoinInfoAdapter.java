...
public class CoinInfoAdapter extends BasicRecycleViewAdapter {
    ...
    protected void bindClickListener(RecyclerView.ViewHolder viewHolder, int position) {
       ...
       coinInfoViewHolder.tvCoinName.setText(map.get("name") +"");
       coinInfoViewHolder.tvCoinPrice.setText(map.get("price")+"");
       coinInfoViewHolder.tvCoinConvert.setText(map.get("cny")+"");
       coinInfoViewHolder.tvCoinRatio.setText(map.get("ratio")+"");
