 ...
 * 充值方式  界面
 */
class PayWayActivity : BasicActivity(), RequestView, ReLoadingData {
    ...
    private var mListAdapter: PayWayListAdapter? = null
    ...
    private fun initView() {
        ...
        val manager = LinearLayoutManager(this@PayWayActivity)
    ...
    private fun responseData() {
        if (mListAdapter == null) {
            mListAdapter = PayWayListAdapter(this@PayWayActivity)
