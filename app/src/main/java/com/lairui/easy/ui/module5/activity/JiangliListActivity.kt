 ...
 * 邀请奖励列表 界面
 */
class JiangliListActivity : BasicActivity(), RequestView, ReLoadingData {
    ...
    private var mRecordAdapter:JiangLiListAdapter? = null
    ...
    private fun initView() {
        ...
        val manager = LinearLayoutManager(this@JiangliListActivity)
    ...
    private fun responseData() {
        if (mRecordAdapter == null) {
            mRecordAdapter = JiangLiListAdapter( this@JiangliListActivity)
