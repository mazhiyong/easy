...
class ZhangHuListAdapter(private val mContext: Context, var datas: List<MutableMap<String, Any>>?) : RecyclerView.Adapter<ZhangHuListAdapter.MyHolder>() {
    ...
    fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.mItemName!!.text = map["orgname"]!!.toString() + ""
