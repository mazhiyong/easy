...
class SignHeTongAdapter(private val mContext: Context, var datas: List<MutableMap<String, Any>>?) : RecyclerView.Adapter<SignHeTongAdapter.MyHolder>() {
    ...
    fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.mItemName!!.text = map["pdfname"]!!.toString() + ""
    ...
    fun onCreateViewHolder(arg0: ViewGroup, arg1: Int): MyHolder {
        // 填充布局
        val view = LayoutInflater.from(mContext).inflate(R.layout.item_hetong_list, arg0, false)
